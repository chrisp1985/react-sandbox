      ...
      <Fragment>
        ...
        >
          ...
          >
            ...
            <DashboardSidebarHeaderItem>Menu items</DashboardSidebarHeaderItem>
            <DashboardSidebarPageItem
              id="projects"
              title="Projects"
              icon={<BarChartIcon />}
              href="/projects"
              selected={!!matchPath('/projects/*', pathname) || pathname === '/projects'}
              defaultExpanded={!!matchPath('/projects/*', pathname) || pathname === '/projects'}
              expanded={expandedItemIds.includes('projects')}
              nestedNavigation={
                <List
                  dense
                  sx={{
            ...
            <DashboardSidebarPageItem
              ...
              icon={<LayersIcon />}
              href="/profile"
              selected={!!matchPath('/profile/*', pathname) || pathname === '/profile'}
            />
          </List>
        </Box>
      </Fragment>
